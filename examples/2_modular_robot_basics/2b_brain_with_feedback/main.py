...
from revolve2.modular_robot_simulation._simulate_scenes import SceneSimulationState
from revolve2.simulators.mujoco_simulator import LocalSimulator
from revolve2.standards import modular_robots_v2, terrains
from revolve2.standards.simulation_parameters import make_standard_batch_parameters
from revolve2.simulation.scene import Joint
...
def main() -> None:
    ...
    # batch_param.simulation_timestep = 200
    # Simulate the scene.
    ...
    scenes_in = scenes[0]
    # ssa= scenes_in.get_modular_robot_simulation_state(robot)
